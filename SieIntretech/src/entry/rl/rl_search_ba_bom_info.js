 ...
 *@NScriptType Restlet
 */
define(['N/file', '../../dao/dao_search_common', 'N/search'], function (file, searchCommon, search) {
    ...
    function post(postParam) {
        ...
        try{
            ...
            for(var key in keyMap) {
                ...
                concatFilters(values, postParam.filters);
    ...
    function concatFilters(schObj, filtersText) {
        ...
        try {
            ...
            schObj.filters = schObj.filters.concat(sch.filters);
        } catch (e) { }
    }
