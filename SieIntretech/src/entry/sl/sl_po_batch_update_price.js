...
define(['N/ui/serverWidget', 'N/search'], function (serverWidget, search) {
    function onRequest(context) {
        if (context.request.method === 'GET') {//直接访问页面是GET方式
            ...
            form.clientScriptModulePath = "./../cs/cs_po_batch_update_price.js";
            //普通按钮
            form.addButton({
                label : '搜索',
            ...
            form.addFieldGroup({ id: "batch_update_price_filter_group", label: expandStr + "过滤条件" });
    ...
    function getRecordFields() {
        ...
        return {
            'custrecord_field_vendor': {
                ...
                label: '供应商编码',
                source: "vendor",
                container: "batch_update_price_filter_group"
            },
            ...
            "cux_po_batch_update_price_tab": {
                id: "cux_po_batch_update_price_tab",
                type: "TAB",
                label: "采购订单价格批量提交",
                "cux_po_batch_update_price": {
                    id: 'cux_po_batch_update_price',
                    type: serverWidget.SublistType.STATICLIST,
                    label: '采购订单价格批量提交',
                    tab: 'cux_po_batch_update_price_tab',
                    fields: [
