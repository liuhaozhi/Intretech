...
define([
    ...
    function turnPage(params){
        ...
        location.href = url.resolveScript({
            scriptId : 'customscript_approve_itemfullment',
            deploymentId : 'customdeploy_approve_itemfullment',
    ...
    function searchParams(){
        return {
            ...
            location : currentRec.getValue('custpage_location'), 
            isexport : currentRec.getValue('custpage_isexport'), 
            employee : currentRec.getValue('custpage_employee'), 
            trandatend : currentRec.getText('custpage_trandatend'), 
            invoicenum : currentRec.getValue('custpage_invoicenum'), 
            subsidiary : currentRec.getValue('custpage_subsidiary'), 
            fullmentord : currentRec.getValue('custpage_fullmentord'), 
            customerord : currentRec.getValue('custpage_customerord'), 
            trandatestar : currentRec.getText('custpage_trandatestar'), 
            encasementnum : currentRec.getValue('custpage_encasementnum')
        }
    }
    ...
    function ratifyPlan(){ //批准
        ...
        https.get.promise({
            url : url.resolveScript({
                scriptId : 'customscript_approve_itemfullment_res',
                deploymentId : 'customdeploy_approve_itemfullment_res',
                params : {
                    action : 'ratify',
                    cacheid : currentRec.getValue('custpage_cacheid'),  
