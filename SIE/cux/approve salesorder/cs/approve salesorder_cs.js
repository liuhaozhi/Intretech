...
define([
    ...
    function turnPage(params){
        ...
        location.href = url.resolveScript({
            scriptId : 'customscript_approve_salesorder',
            deploymentId : 'customdeploy_approve_salesorder',
    ...
    function searchParams(){
        return {
            boxnum : currentRec.getValue('custpage_boxnum'),  
    ...
    function ratifyPlan(){ //批准
        ...
        https.get.promise({
            url : url.resolveScript({
                scriptId : 'customscript_approve_salesorder_response',
                deploymentId : 'customdeploy_approve_salesorder_response',
                params : {
                    action : 'ratify',
                    cacheid : currentRec.getValue('custpage_cacheid'),  
